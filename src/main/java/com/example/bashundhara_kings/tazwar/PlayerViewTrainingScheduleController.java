...
public class PlayerViewTrainingScheduleController {

    @FXML private TableView<TrainingSchedule> trainingTable;
    ...
    @FXML private TableColumn<TrainingSchedule, String> coachNameCol;
    ...
    public void initialize() {
        ...
        // coachName is not in model yet; placeholder column
        coachNameCol.setCellValueFactory(new PropertyValueFactory<>("venue"));

        List<TrainingSchedule> schedules = loadFromFile();
        if (schedules.isEmpty()) {
            statusLabel.setText("No training schedules assigned.");
        } else {
            trainingTable.setItems(FXCollections.observableArrayList(schedules));
        }
    }
